...
def plotar_zonas_de_distancia(n_clicks, line_imp, line_ang,
    ...
    try:
        ...
        if z1_type == 'mho':
            ...
            fig.add_trace(go.Scatter(
                x=[0, R_reach_z1, R_reach_z1, 0, 0], y=[0, 0, X_reach_z1, X_reach_z1, 0],
                fill="toself", fillcolor="rgba(0, 156, 255, 0.1)", line_color="#009cff", name="Zona 1 (Quad)"
            ))
        ...
        if z2_type == 'mho':
            ...
            fig.add_trace(go.Scatter(
                x=[0, R_reach_z2, R_reach_z2, 0, 0], y=[0, 0, X_reach_z2, X_reach_z2, 0],
                fill="toself", fillcolor="rgba(255, 13, 87, 0.1)", line_color="#ff0d57", name="Zona 2 (Quad)"
            ))
