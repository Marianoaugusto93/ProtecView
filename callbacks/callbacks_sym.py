...
def calcular_componentes_bidirecional(n_clicks, direction,
    ...
    fig_vazia = go.Figure(layout=go.Layout())
    ...
    try:
        ...
        if direction == 'phase-to-sym':
            ...
            V_b = V_in_2;
            V_c = V_in_3
            V_out_1 = (1 / 3) * (V_a + V_b + V_c);
            V_out_2 = (1 / 3) * (V_a + a * V_b + (a ** 2) * V_c);
            V_out_3 = (1 / 3) * (V_a + (a ** 2) * V_b + a * V_c)
            ...
            V_2 = V_in_3
            V_out_1 = V_0 + V_1 + V_2;
            V_out_2 = V_0 + (a ** 2) * V_1 + a * V_2;
            V_out_3 = V_0 + a * V_1 + (a ** 2) * V_2
        ...
        # [CORREÇÃO] Chamada à função create_phasor_diagram
        # A própria função create_phasor_diagram em utils_sym.py também precisa
        # ter 'template="plotly_dark"' removido!
